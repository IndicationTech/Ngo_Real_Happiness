...
export default function About() {
  ...
  const milestones = [
    ...
    { year: "2022", event: "Opened our first school serving 200 children" },
    {
      year: "2023",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-6xl mx-auto leading-relaxed">
            <b>Real Happiness Of Life Foundation</b> is a Section 8,
            not-for-profit organization established in <b>2021</b> with a
            singular mandate: to drive inclusive, measurable, and sustainable
            social transformation. The Foundation works at the intersection of
            education, health, women empowerment, livelihoods, and environmental
            sustainability, partnering closely with communities, institutions,
            and governments to deliver high-impact outcomes.
            <br />
